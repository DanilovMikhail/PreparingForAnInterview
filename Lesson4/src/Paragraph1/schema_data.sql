...
INSERT INTO `film` VALUES
    (1,'Матрица 1',120),
    (2,'Матрица Перезагрузка',120),
    (3,'Матрица Революция',90),
    (4,'Матрица Воскрешение',120),
    (5,'Терминатор',60),
    (6,'Терминатор 2: Судный день',120),
    (7,'Терминатор 3: Восстание машин',60),
    (8,'Терминатор: Да придет спаситель',60),
    (9,'Терминатор: Генезис',90),
    (10,'Терминатор: Темные судьбы',90);
UNLOCK TABLES;
...
INSERT INTO `poster` VALUES
    (1,'2022-01-27 09:00:00',1,100),
    (2,'2022-01-27 11:00:00',5,200),
    (3,'2022-01-27 12:30:00',2,300),
    (4,'2022-01-27 15:00:00',6,400),
    (5,'2022-01-27 17:30:00',3,600),
    (6,'2022-01-27 19:30:00',7,600),
    (7,'2022-01-27 20:30:00',5,700),
    (8,'2022-01-27 22:00:00',4,800);
UNLOCK TABLES;
